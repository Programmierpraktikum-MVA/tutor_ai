...
import re
from paths import ISIS_ALL_COURSE_IDS_FILE, ISIS_ALL_COURSE_IDS_HTML, ensure_dir
...
def download_all_course_page(driver):
    ...
    ensure_dir(ISIS_ALL_COURSE_IDS_HTML.parent)
    with open(ISIS_ALL_COURSE_IDS_HTML, "w", encoding="utf-8") as f:
        f.write(html_content)


def scrape_all_course_html():
    with open(ISIS_ALL_COURSE_IDS_HTML, "r", encoding="utf-8") as f:
        all_courses = f.read()
    ...
    ensure_dir(ISIS_ALL_COURSE_IDS_FILE.parent)
    with open(ISIS_ALL_COURSE_IDS_FILE, "w", encoding="utf-8") as json_file:
